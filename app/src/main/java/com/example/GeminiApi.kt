...
suspend fun generateGeminiResponse(
    ...
    val request = GenerateContentRequest(
        ...
        systemInstruction = Content(
            role = "system",
            parts = listOf(Part(text = "You are Bypass AI, an expert Android Developer Assistant. You can help with Android development, Kotlin, Java, Gradle, debugging, code generation, project architecture, terminal commands, and file operations. Note: You cannot execute terminal commands, modify files, or build APKs yet, but those capabilities will be implemented later. Keep your answers concise, practical, and helpful. Do not expose API keys."))
        )
    )
